export const contactTemplate = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>Contact par mon portfolio</title>
          ...
          >
            <tr>
              <td valign="top" class="r1-i" style="background-color: #ffffff">
                ...
                >
                  <tr>
                    <td class="r9-i" style="padding-top: 20px">
                      <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                        <tr>
                          <th width="100%" valign="top" class="r5-c" style="font-weight: normal">
                            <table
                                                      ...
                                                      <tr>
                                                        <td valign="top" class="r7-i" style="padding-left: 15px; padding-right: 15px">
                                                          <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                                            <tr>
                                                              <td
                                                                class="r11-c nl2go-default-textstyle"
                                                                align="left"
                                                                style="
                                                                  color: #3b3f44;
                                                                  font-family: arial, helvetica, sans-serif;
                                                            ...
                                                            <tr>
                                                              <td class="r14-c" align="left">
                                                                ...
                                                                >
                                                                  <tr>
                                                                    <td class="r15-i" style="padding-bottom: 15px; height: 3px">
                                                                      <table
                                                                        width="100%"
                                                                        cellspacing="0"
                                                                        cellpadding="0"
                                                                ...
                                                                >
                                                                  <tr>
                                                                    <td
                                                                      ...
                                                                      "
                                                                    >
                                                                      <div><p style="margin: 0">{{body}}</p></div>
                                                                    </td>
                                                                  </tr>
                                                                  <tr class="nl2go-responsive-hide">
